...
grViz("digraph{
 ...
 A[label = 'Code: Aware of the list']
 B[label = 'Code: List is helpful(Parents)']
 C[label = 'Code: List is helpful(Professional']
 D[label = 'Code: Refer to the list']
 ...
 R1[label = 'I was familiar with the condition \nStatement that child could be eligible\n under that so it was just part\n of learning about the job initially\n but not part of the training that I had.']
 
 R3[label = 'It is publicly available but I do \nnot know that parents know that document. \nIt is buried with in documents that\n a parent would be going like oh\n yeah I know where that is at.']
 
 R4[label = 'Oh! We may have our own list of\n what we interpret as the state of \nOregon as accepting as a category for\n other health impairment, emotional \ndisturbance, specific learning disability.']
 }
 ...
 label = 'Summary'
 node[shape = rectangle, fillcolor = LemonChiffon, margin = 0.25]
 S1[label = 'I was familiar with the condition \nStatement that child could be eligible\n under that 
 so it was just part\n of learning about the job initially\n but not part of the training that I had.']
